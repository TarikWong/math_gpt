...
3. "kc"是一个 json 数组，数组的每个元素是一个字典，其中键为步骤step，值为另一个数组，包含了该步骤的知识点列表。
4. "reason"是一个数组，数组的每个元素是一个字典，其中键为步骤step，值为另一个字典，键为"kc"中对应步骤step的知识点，值为该知识点为什么符合要求的推理过程文字描述。